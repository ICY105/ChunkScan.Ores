...
#init scores
scoreboard objectives add chunk_scan.ores.data dummy

scoreboard players set #registry.id chunk_scan.ores.data 1
scoreboard players set #cons.8 chunk_scan.ores.data 8
scoreboard players set #cons.16 chunk_scan.ores.data 16
scoreboard players set #cons.256 chunk_scan.ores.data 267
