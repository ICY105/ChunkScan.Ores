...
execute if score #gen.biome_blacklist chunk_scan.ores.data matches 0..1 if data storage chunk_scan.ores:generation chunk.list[0].biomes[0] run function chunk_scan.ores:v1.0/generation/check_biome
