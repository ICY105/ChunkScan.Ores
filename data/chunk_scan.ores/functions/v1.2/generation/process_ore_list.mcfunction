...
#execute if data storage chunk_scan.ores:generation chunk.list[0] run function chunk_scan.ores:v1.2/generation/process_ore_list with storage chunk_scan.ores:generation chunk.list[0]
