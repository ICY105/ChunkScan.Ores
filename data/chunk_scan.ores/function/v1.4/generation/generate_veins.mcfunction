...
# displace
execute if score #gen.vein_size chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.4/generation/displace with storage chunk_scan.ores:temp obj
