...
execute if score #gen.veins chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.4/generation/generate_veins with storage chunk_scan.ores:generation chunk.list[0]
...
execute if data storage chunk_scan.ores:generation chunk.list[0] run function chunk_scan.ores:v1.4/generation/process_ore_list with storage chunk_scan.ores:generation chunk.list[0]
