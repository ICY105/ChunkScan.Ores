...
# generate ores
execute if score #registry.id chunk_scan.ores.data matches 2.. run function chunk_scan.ores:v1.4/registry/get_entry with storage chunk_scan.ores:generation chunk
...
execute if score #registry.id chunk_scan.ores.data matches 2.. if data storage chunk_scan.ores:generation chunk.list[0] run function chunk_scan.ores:v1.4/generation/process_ore_list with storage chunk_scan.ores:generation chunk.list[0]
execute if score #registry.id chunk_scan.ores.data matches 2.. if data storage chunk_scan.ores:generation chunk.list[0] run function chunk_scan.ores:v1.4/generation/reset_seed with storage chunk_scan.ores:generation chunk
