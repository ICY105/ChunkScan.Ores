...
execute if score #gen.success chunk_scan.ores.data matches 0 if score #gen.loop chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.4/generation/get_ore_list_2
