...
execute if score #gen.failed chunk_scan.ores.data matches 1 if score #gen.loop chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.4/generation/get_ore_list_2
